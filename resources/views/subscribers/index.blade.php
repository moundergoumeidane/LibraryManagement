                        ...
                        <div>
                            ...
                            <table class="table table-striped">
                                ...
                                @endif
                                    ...
                                    <td>
                                        <a href="/subscribers/{{$s -> id}}" class="text-decoration-none">
                                            <i class="fas fa-eye"></i>
                                        </a>
                                        <a href="/subscribers/{{$s -> id}}/edit" class="text-decoration-none mx-2">
                                            <i class="fas fa-pen"></i>
                                        </a>
                                        <a onclick="deleteSubscriber({{$s -> id}})"
                                        ...
                                        <form action="/subscribers/{{$s -> id}}" method="post" id="form-delete-{{$s -> id}}">
                                            @csrf
                                            @method('delete')
